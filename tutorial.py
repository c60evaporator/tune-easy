...
# tuning.plot_first_validation_curve(validation_curve_params=params, cv=LeaveOneGroupOut())
# tuning.grid_search_tuning(cv_params=params, cv=LeaveOneGroupOut())
# tuning.random_search_tuning(cv_params=params, n_iter=50, cv=LeaveOneGroupOut())
...
tuning.bayes_opt_tuning(bayes_params=params, n_iter=50, cv=LeaveOneGroupOut())
#tuning.optuna_tuning(bayes_params=params, n_trials=50, cv=LeaveOneGroupOut())
tuning.plot_best_validation_curve()
